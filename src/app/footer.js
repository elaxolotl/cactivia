    ...
    return (
        <footer className="bg-[#59760B] text-white py-6">
            <div className="container mx-auto text-center">
                <p className="text-sm mb-2">© 2023 Cactivia. All rights reserved.</p>
                <div className="flex justify-center gap-2">
                    ...
                    <a href="https://www.linkedin.com/company/3zero-campus-club-tunisia/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300">
