    ...
    return (
        <div className="bg-[#F6F6F6]">
            ...
            <div className="mx-[10vw]">
                <div className="bg-[#d1d1d1]/20 backdrop-blur-md rounded-xl shadow-[0_7px_0_0_black] p-4 flex flex-col gap-2 w-full max-w-3xl mt-[-10vh]">
                ...
                <div className="flex flex-col items-center mt-10 text-black">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        {steps.map((step, index) => (
                            <>
                                <div className="text-[15vw] font-bold text-[#59760b] mb-[-8vh]">{String(index + 1).padStart(2, "0")}</div>
                                <div key={step.id} className="p-5 rounded-lg bg-white shadow-md flex items-start gap-4">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-2">
                                            <div className="text-2xl p-2 bg-[#d1d1d1] rounded-xl text-[#59760b]">{step.icon}</div>
